...
const VerifyOTP = () => {
  ...
  useEffect(() => {
    if (location.state?.otp_token) {
      setOtpToken(location.state.otp_token);
    }
  }, [location.state]);
  ...
  const handleResendOTP = () => {
    ...
    dispatch(resendOTP(resendVerificationData))
      .unwrap()
      .then((response) => {
      ...
      .catch((response) => {
        console.log("resendOTP Verification Response error:", response);
      });
  };
