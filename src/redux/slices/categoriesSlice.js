...
export const fetchcategories = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const [artworkCategories, artworksCategoriesImage] = await Promise.all([
        productsApi.getArtworkCategories(),
        productsApi.getArtworkCategoryImages(),
      ]);

      return {
        artworksCategories: artworkCategories,
        artworksCategoriesImage,
      };
    } catch (error) {
